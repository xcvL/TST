...
const targetLangsArr = Object.keys(targetLangsObj);

let currentTargetLang = "en";
let consoleCurrentTargetLang = currentTargetLang;
...
document.addEventListener("keydown", (e) => {
    if(e.ctrlKey && e.key.toLowerCase() == "m") {
        ...
        if(opt === "help") {
            ...
            console.log(`Change completed. ( ${targetLangsObj[consoleCurrentTargetLang]} → ${targetLangsObj[opt]} )`);
            consoleCurrentTargetLang = currentTargetLang;
        } else {
            console.log("failed.")
        }
        console.log("");
